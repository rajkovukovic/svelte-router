...
/* src/components/route.svelte generated by Svelte v3.38.2 */
...
/* src/components/router.svelte generated by Svelte v3.38.2 */
...
/* src/components/navigate.svelte generated by Svelte v3.38.2 */
...
class Navigate extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { to: 0, title: 1, styles: 2, lang: 4 });
	}
}

console.log({ activeRoute: activeRouteReadable, from: "svelte-router/src/index.js" });

export { Navigate, Route, Router, SpaRouter, activeRouteReadable as activeRoute, localisedRoute, navigateTo, routeIsActive };
